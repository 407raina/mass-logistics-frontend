        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white tracking-wide">Receipt Cancellation</h1>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 rounded-xl p-6 mb-8 shadow-lg">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-yellow-800 mb-2">Receipt cancellation is a permanent action that cannot be undone. </h3>
            </div>
          </div>
        </div>
